...
1. Understands the meaning of a question
2. Retrieves the most relevant document content semantically
3. Generates answers strictly grounded in the source documents
